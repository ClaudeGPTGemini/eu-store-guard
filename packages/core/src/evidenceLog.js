...
export function evidenceEntry({ storeId, marketCountry, locale, productId = null, ruleId, ruleVersion, status, technicalStatus = null, reasons = [], assetHash = null, activation = null, now = new Date() }) {
